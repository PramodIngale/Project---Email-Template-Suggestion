...
if rad == "Application Description":
    ...
    **Note:** *Some of the valid keywords are as follows: Laeve request, Resignation, Job application, Request fro credit card, Compliants of defective products, Reqest for passbook, Cancellation of internet services, Request for refund, College addmission application, Loan application, Sick leave etc.*  """, True)
