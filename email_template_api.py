...
if rad == "Application Description":
    ...
    **Note:** *Some of the valid keywords are as follows: Leave request, Resignation, Job application, Request for credit card, Complaints of defective products, Request for passbook, Cancellation of internet services, Request for refund, College admission application, Loan application, Sick leave etc.*  """, True)    st.image("keyword and search button.PNG", width=500)
